    ...
    <section>
      <div className="mb-10 <sm:mx-4 mt-15 md:mt-20 xl:px-5">
        <div className="mx-auto container @2xl:min-w-[760px]">
          <nav className="flex justify-between items-center px-4 py-4 md:(px-10 py-5) xl:px-12 header-bg border-l-2 border-fuchsia-400 rounded-tl-lg rounded-tr-lg box-shadow-container">
            <h2 className="flex font-serif text-lg md:text-xl lg:font-semibold text-white uppercase tracking-wider title-text-shadow">
              {breadcrumb && (
                <span className="breadcrumb">
                  <Link
                    to="/"
                    className="opacity-75 hover:opacity-100 focus:(opacity-100 outline-none ring-2 ring-offset-2 ring-blue-gray-200)"
                  >
                    Home
                  </Link>
                </span>
              ...
              {title && (
                <>
                  {viewAll ? (
                    <Link
                      className="focus:(outline-none ring-2 ring-offset-2 ring-blue-gray-200)"
                      to={viewAll}
                    >
                      {title}
                    </Link>
            ...
            {viewAll && (
              <Link
                to={viewAll}
                className="flex font-serif items-center text-xs md:text-sm text-gray-300 uppercase tracking-wide hover:(text-white animate-pulse) focus:(outline-none ring-2 ring-offset-2 ring-blue-gray-200)"
              >
                More Info
                <ArrowRightIcon
    ...
    <section>
      <div className="pb-25 <sm:mx-4 mt-15 xl:px-0">
        <div className="mx-auto container xl:max-w-[1000px] @md:px-4">
          <div className="flex justify-center px-4 py-4 md:(px-10 py-5) xl:px-12 header-bg border-l-2 border-fuchsia-400 rounded-tl-lg rounded-tr-lg section-container-box-shadow">
