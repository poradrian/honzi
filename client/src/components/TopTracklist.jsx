            ...
            <table className='min-w-full mt-4 md:(mt-0 divide-y divide-blue-gray-600)'>
              <thead>
                <tr>
                  <th
                    scope='col'
                    className='<sm:hidden pl-4.5 text-left text-s font-medium text-gray-500 uppercase tracking-wider'>
              ...
              {tracks && tracks.length ? (
                <tbody>
                  {tracks.map((track, i) => (
                    <tr
                      key={track.id}
                      className='text-true-gray-400 text-sm lg:text-base tabular-nums hover:bg-blue-gray-700 focus:bg-blue-gray-700 '>
